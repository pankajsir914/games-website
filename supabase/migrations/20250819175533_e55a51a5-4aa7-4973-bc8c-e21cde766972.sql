-- Restrict create_user_simple: only admins/master_admins can create users; only master_admin can create admin users
...
BEGIN
  ...
  -- Only admins or master admins can create users
