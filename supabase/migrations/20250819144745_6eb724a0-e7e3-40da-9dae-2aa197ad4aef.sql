-- Correct create_user_simple to create Auth user via Edge Function and return proper JSON
...
BEGIN
  ...
  -- Call the create-user edge function (handles auth user, profile, wallet, roles)
