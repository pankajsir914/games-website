-- Update function to allow any authenticated user to create regular users, while restricting admin user creation to master admins
...
BEGIN
  ...
  -- Permission rules:
  -- - Any authenticated user can create a regular 'user'
