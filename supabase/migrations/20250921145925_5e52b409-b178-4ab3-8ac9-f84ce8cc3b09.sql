-- Security Fix Implementation - Phase 1

-- 1. Fix ludo_player_sessions RLS (it's a table, not a view)
...
-- 2. Fix poker_game_events RLS (make it more restrictive)
...
BEGIN
  ...
  SELECT COUNT(*) > 0 INTO v_session_valid
  FROM user_sessions
