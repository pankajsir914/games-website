...
interface Roulette13BettingProps {
  betTypes: any[];
...
export const Roulette13Betting = ({
  betTypes = [],
  onPlaceBet,
  loading = false,
}: Roulette13BettingProps) => {
  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-sm font-semibold">Roulette</h3>
      ...
      <Dialog open={rulesOpen} onOpenChange={setRulesOpen}>
        <DialogContent className="max-w-md text-sm max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-3 text-xs leading-relaxed">
            <div>
              <p>
                Roulette is a classic casino game. This game is played with 
