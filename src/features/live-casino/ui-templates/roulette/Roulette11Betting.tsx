...
interface Roulette11BettingProps {
  betTypes: any[];
...
export const Roulette11Betting = ({
  betTypes = [],
  onPlaceBet,
  loading = false,
}: Roulette11BettingProps) => {
  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-sm font-semibold">Golden Roulette</h3>
      ...
      <Dialog open={rulesOpen} onOpenChange={setRulesOpen}>
        <DialogContent className="max-w-md text-sm max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Golden Roulette Rules</DialogTitle>
          </DialogHeader>

          <div className="space-y-3 text-xs leading-relaxed">
            <div>
              <p>
                Golden Roulette is a European-style roulette game. This game is played with 
