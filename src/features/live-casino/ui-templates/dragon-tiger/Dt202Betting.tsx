    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
        ...
        <div className="border rounded-lg p-2">
          <div className="text-xs font-bold mb-2 text-white text-center">DRAGON</div>
        ...
        {/* TIGER BLOCK */}
        <div className="border rounded-lg p-2">
          <div className="text-xs font-bold mb-2 text-white text-center">TIGER</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
        ...
        <div className="border rounded-lg p-2">
          <div className="text-xs font-bold mb-2 text-white text-center">DRAGON 12</div>
        ...
        <div className="border rounded-lg p-2">
          <div className="text-xs font-bold mb-2 text-white text-center">TIGER 12</div>
