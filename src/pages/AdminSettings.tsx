...
import { Settings, Server, Globe, Database, Bell, Shield } from 'lucide-react';
    ...
    <AdminLayout>
      <div className="space-y-8">
        <div>
          ...
          <p className="text-muted-foreground">Manage your platform settings and configuration.</p>
        </div>
